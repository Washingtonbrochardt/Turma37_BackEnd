...
public class Carro {
	...
	//construtor vazio/padr�o [eu n�o gostei ed/laine]
	public Carro() {
		
	}

	//ENCAPSULAMENTO - SEGURAN�A DE DADOS - getters(pega-mostra) and setters(alterar-troca)
	...
	public void pararCarro() {
		if (this.ligado && this.velocidade==0 && this.marcha ==0) {
			descerMarcha(); //reduzir a machar at� 1
